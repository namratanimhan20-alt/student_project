...
// Total Transactions
// ============================
$count_query = "SELECT COUNT(*) AS total_transactions
                FROM transactions
                WHERE user_id='$user_id'";
...
<div class="dashboard-container">
    ...
    <div class="dashboard-cards">
        ...
        <div class="card balance-card">
            ...
            <h2 class="<?php echo ($balance >= 0) ? 'positive' : 'negative'; ?>">
    ...
    <div class="actions">
        ...
        <a href="transaction.php" class="btn secondary-btn">
            View Transactions
        </a>
                ...
                while ($row = mysqli_fetch_assoc($transactions)) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                            if ($row['type'] == "Income") {
                                echo "<span class='income'>Income</span>";
                            } else {
                                echo "<span class='expense'>Expense</span>";
                            }
                            ?>
